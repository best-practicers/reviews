...
abstract contract customInterface {
 ...
 /// @title PunkProxy 
 /// @author 
 /// @notice it works as proxy contract for executing the call for BatchSwap contracts for handling of cryptopunk tokens 
 /// @params owner  the owner who has initiated the proxy contract 
 /// @params punkOwner the owner of the cryptopunk  NFT's .
 /// @dev in order to add new methods for the transfer operations , define the function in the CPInterface , and then 
contract PunkProxy {
...
/// @title batchswap contract
/// @author The name of the author
/// @notice primary contract created by proxycall ( for hosting the non 721 compliant token trading like cryptopunks) for doing p2P OTC swaps .
/// @dev 
